...
const start = () => {
    inquirer
        ...
        .then((answer) => {
            ...
            if (answer.addUpdate === 'Add departments, roles, employees') {
                addStuff();
            } else if (answer.addUpdate === 'View departments, roles, employees') {
                viewStuff();
            } else if (answer.addUpdate === 'Update employee roles') {
                updateStuff();
            } else {
                connection.end();
            }
