...
const viewRole = () => {
  // query the database for all employees
  connection.query('SELECT role_title AS Roles, salary AS Salary, dept_name AS department FROM role INNER JOIN Department ON department.id = role.dept_id ', (err, results) => {
